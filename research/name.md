...
- It must contain only URL-safe characters
  - > TODO: What are "URL-safe characters"? 
...
## Sources
- npm's official documentation for the `name` field: https://docs.npmjs.com/cli/v10/configuring-npm/package-json#name
- npm's document for Scope: https://docs.npmjs.com/cli/v10/using-npm/scope
